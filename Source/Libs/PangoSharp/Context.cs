...
namespace Pango {
	...
	public partial class Context {
		...
		static d_pango_context_list_families2 pango_context_list_families2 = Marshal.GetDelegateForFunctionPointer<d_pango_context_list_families2>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Pango), "pango_context_list_families"));
		...
		static d_pango_context_list_families pango_context_list_families = Marshal.GetDelegateForFunctionPointer<d_pango_context_list_families>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Pango), "pango_context_list_families"));
